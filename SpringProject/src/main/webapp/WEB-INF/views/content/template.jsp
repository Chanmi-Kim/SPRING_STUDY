...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="stylesheet" href="/spring/resources/css/themefisher-fonts.min.css">
        ...
        <link id="color-changer" rel="stylesheet" href="/spring/resources/css/red.css">
    </head>
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                                <div class="page-title home text-center">
                                    <img src="/spring/resources/images/phantom.png" alt="">
        ...
        ================================= -->
        <script src="/spring/resources/js/jquery-2.2.4.min.js"></script>
        <script src="/spring/resources/js/bootstrap.min.js"></script>
        <!-- <script src="js/jquery.easing.min.js"></script> -->
        <script src="/spring/resources/js/isotope.pkgd.min.js"></script>
        <script src="/spring/resources/js/jquery.nicescroll.min.js"></script>
        <script src="/spring/resources/js/owl.carousel.min.js"></script>
        <script src="/spring/resources/js/jquery-validation.min.js"></script>
        <script src="/spring/resources/js/form.min.js"></script>
